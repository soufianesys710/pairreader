...
class TestVectorStore:
    ...
    @pytest.mark.unit
    def test_vectorstore_initialization_persistent(
        self, mock_chromadb_client, mock_chromadb_collection
    ):
    ...
    @pytest.mark.unit
    def test_vectorstore_initialization_ephemeral(
        self, mock_chromadb_client, mock_chromadb_collection
    ):
    ...
    @pytest.mark.unit
    def test_vectorstore_initialization_creates_collection(
        self, mock_chromadb_client, mock_chromadb_collection
    ):
